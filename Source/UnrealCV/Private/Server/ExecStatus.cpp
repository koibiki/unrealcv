...
FExecStatus FExecStatus::InvalidArgument = FExecStatus(FExecStatusType::FEError, "Argument Invalid");
FExecStatus FExecStatus::NotImplemented = FExecStatus(FExecStatusType::FEError, "Not Implemented");
FExecStatus FExecStatus::InvalidPointer = FExecStatus(FExecStatusType::FEError, "Pointer to object invalid, check log for details");
...
{
	return FExecStatus(FExecStatusType::FEError, ErrorMessage);
}
