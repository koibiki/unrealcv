...
FExecStatus FAliasHandler::VExecWithOutput(const TArray<FString>& Args)
{
	...
	// https://answers.unrealengine.com/questions/301428/set-string-for-fstring-via-FProperty.html
	// for (TFieldIterator<FIntProperty> It(Function); It && It->HasAnyPropertyFlags(CPF_ReturnParm); ++It)
	...
	// for (TFieldIterator<FNumericProperty> It(Function); It && It->HasAnyPropertyFlags(CPF_ReturnParm); ++It)
